...
export default class Recommended extends Component {
    render() {
        ...
        return (
            <section>
                <h2 className="font-light text-xl md:text-[2rem] text-white pl-4 md:pl-[1.5625rem] my-[1.3125rem] md:mt-12 md:mb-7 transition-all">Recommended for you</h2>
