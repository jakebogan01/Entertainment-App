    ...
    render() {
        return (
            <nav className="flex justify-between items-center bg-[#161D2F] py-[1.125rem] px-4">
                <Link to="/" className="text-[#FC4747] hover:text-white transition-colors">
                    <svg width="33" height="27" fill="currentColor" className="hidden"
                    ...
                    <svg width="25" height="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="m20 0 2.5 5h-3.75l-2.5-5h-2.5l2.5 5H12.5L10 0H7.5L10 5H6.25l-2.5-5H2.5A2.489 2.489 0 0 0 .013 2.5L0 17.5A2.5 2.5 0 0 0 2.5 20h20a2.5 2.5 0 0 0 2.5-2.5V0h-5Z"/>
                    </svg>
                </Link>

                <ul className="flex items-center space-x-6">
                    <li>
                        <Link to="#" className="text-white hover:text-[#FC4747] transition-colors">
                            <svg width="20" height="20" fill="currentColor" className="hidden"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <Link to="#" className="text-[#5A698F] hover:text-[#FC4747] transition-colors">
                            ...
                            <svg width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
                                      d="M13.564 0H2.436A2.436 2.436 0 0 0 0 2.436v11.128A2.436 2.436 0 0 0 2.436 16h11.128A2.435 2.435 0 0 0 16 13.564V2.436A2.435 2.435 0 0 0 13.564 0ZM3.2 7.2H1.6V5.6h1.6v1.6Zm0 1.6H1.6v1.6h1.6V8.8Zm11.2-1.6h-1.6V5.6h1.6v1.6Zm0 1.6h-1.6v1.6h1.6V8.8Zm0-6.608V3.2h-1.6V1.6h1.008a.592.592 0 0 1 .592.592ZM3.2 1.6H2.192a.592.592 0 0 0-.592.592V3.2h1.6V1.6ZM1.6 13.808V12.8h1.6v1.6H2.192a.592.592 0 0 1-.592-.592Zm11.2.592h1.008a.592.592 0 0 0 .592-.592V12.8h-1.6v1.6Z"/>
                            </svg>
                        </Link>
                    </li>
                    <li>
                        <Link to="#" className="text-[#5A698F] hover:text-[#FC4747] transition-colors">
                            ...
                            <svg width="16" height="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
                                      d="M7.264 3.585H16V16H0V3.585h3.936L1.776.962 3.024.023 5.6 3.127 8.176 0l1.248.962-2.16 2.623ZM1.6 14.448h8V5.137h-8v9.311Zm12-3.104H12V9.792h1.6v1.552ZM12 8.241h1.6V6.689H12V8.24Z"/>
                            </svg>
                        </Link>
                    </li>
                    <li>
                        <Link to="#" className="text-[#5A698F] hover:text-[#FC4747] transition-colors">
                            <svg width="17" height="20" fill="currentColor" className="hidden"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <Link to="#"
                      className="w-6 h-6 border-2 border-white hover:border-[#FC4747] rounded-full overflow-hidden transition-colors">
