        ...
        return (
            <div>
                ...
                <div className="relative">
                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 md:pl-[1.5625rem] transition-all">
                    ...
                    <input id="search" name="search" className="block w-full outline-none outline-0 border-none border-0 border-transparent bg-transparent py-[1.625rem] md:py-9 caret-red-500 pl-12 md:pl-16 pr-4 md:pr-[1.5625rem] placeholder-[#87898D] focus:border-transparent focus:bg-transparent focus:text-white focus:placeholder-gray-500 focus:outline-none focus:ring-0 focus:ring-transparent focus:placeholder:text-transparent font-light text-base md:text-2xl transition-all" placeholder={this.props.title} type="search"/>
                </div>
            </div>
        );
    }
