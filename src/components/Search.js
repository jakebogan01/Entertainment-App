        ...
        return (
            <div>
                ...
                <div className="relative">
                    ...
                    <input id="search" name="search" className="block w-full border border-transparent bg-transparent py-[1.625rem] caret-red-500 pl-12 pr-4 placeholder-[#87898D] focus:border-transparent focus:bg-transparent focus:text-white focus:placeholder-gray-500 focus:outline-none focus:ring-transparent focus:placeholder:text-transparent text-base" placeholder={this.props.title} type="search"/>
                </div>
            </div>
        );
    }
