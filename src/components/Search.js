...
export default class Search extends Component {
    render() {
        let searchTerm;
        const setUsernameReg = (value) => {
            searchTerm = value;
        }

        return (
            <form className="1440:mt-16 transition-all" onSubmit={(e) => this.props.handleSubmit(e, searchTerm)}>
