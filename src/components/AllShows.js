...
export default class AllShows extends Component {
    render() {
            ...
            cards.push(
                <div>
                    ...
                    <div className="flex flex-col justify-end mt-2 mb-1">
                        <p className="font-light text-white text-[0.6875rem]">2019 &#160;&#183;&#160; <svg width="10" height="10" fill="none" className="inline transform -translate-y-[0.06rem]" xmlns="http://www.w3.org/2000/svg"><path opacity=".75" fillRule="evenodd" clipRule="evenodd" d="M4.54 2.24H10V10H0V2.24h2.46L1.11.602l.78-.586 1.61 1.94L5.11 0l.78.601-1.35 1.64ZM1 3.21v5.82h5V3.21H1Zm7.5 3.88h-1v-.97h1v.97Zm-1-1.94h1v-.97h-1v.97Z" fill="#fff"/></svg>&#160; TV Series &#160;&#183;&#160; PG</p>
                        <h3 className="text-white font-medium text-sm">Dark Side of the Moon</h3>
                    </div>
                </div>
            );
        }
        return (
            <section>
                <h2 className="font-light text-xl text-white pl-4 mb-[1.3125rem]">TV Series</h2>
