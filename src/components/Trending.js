    ...
    render() {
        ...
        return (
            <section>
                ...
                <Slider {...settings}>
                    {this.props.popularMovies.slice(0, 5).map((movie) => (
                        <div key={movie.id} className={movie.backdrop_path ? 'block' : 'hidden'}>
                            <div className="relative flex flex-col bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://image.tmdb.org/t/p/w500/" + movie.backdrop_path + "')"}}>
